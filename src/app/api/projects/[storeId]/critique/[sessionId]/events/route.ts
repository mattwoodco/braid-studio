/**
 * GET /api/projects/[storeId]/critique/[sessionId]/events
 * SSE proxy of the critique session event stream. Forwards
 * span.outcome_evaluation_* events untouched so the UI can show iteration N/M.
 */
